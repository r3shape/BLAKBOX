...
class BOXwindow(BOXatom):
    def __init__(
        ...
        self.icon: pg.Surface = pg.image.load(box_path("assets/images/logo.ico"))
    ...
    def blits(self, surface: pg.Surface, pos: list[int], offset: list[float]=[0.0, 0.0], rect: pg.Rect=None) -> None:
